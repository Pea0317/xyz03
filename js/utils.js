...
function deduplicateContentArray(arr, baseSystemArray = []) {
    ...
    return { result, removedCount };
        ...
        const playSound = (type, loopOverride) => {
            ...
            const INVITE_TYPES = ['invite_study', 'invite_work', 'invite_exercise', 'invite_sleep', 'invite_videocall', 'invite_voice', 'invite_call'];
            if (INVITE_TYPES.indexOf(type) !== -1) {
                try {
                    ...
                    const inviteKey = {
                        ...
                        invite_voice:     { preset: 'inviteVideocallSoundPreset', custom: 'inviteVideocallCustomSoundUrl', defaultFile: 'assets/audio/invite_videocall.mp3' },
                        invite_call:      { preset: 'inviteVideocallSoundPreset', custom: 'inviteVideocallCustomSoundUrl', defaultFile: 'assets/audio/invite_videocall.mp3' }
                    }[type];
