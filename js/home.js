...
(function() {
    ...
    const defaultAppIcons = {
        ...
        music: '<i class="fas fa-headphones"></i>',
        quiz: '<i class="fas fa-question-circle"></i>',
        stats: '<i class="fas fa-chart-bar"></i>',
        accounting: '<i class="fas fa-coins"></i>'
    };

    const defaultAppOrder = ['chat', 'mailbox', 'moyu', 'call-records', 'diary', 'fortune', 'mood', 'calendar', 'decide', 'music', 'quiz', 'stats', 'accounting', 'map'];
    ...
    window.openApp = function(app) {
        const appActions = {
            ...
            'music': () => {
                ...
                if (modal) {
                    homeShowModal(modal);
                    if (typeof window.MusicApp === 'object' && typeof window.MusicApp.onShow === 'function') {
                        window.MusicApp.onShow();
                    }
                }
            },
            'quiz': () => {
                ...
                if (modal) {
                    homeShowModal(modal);
                    if (typeof window.QuizApp === 'object' && typeof window.QuizApp.onShow === 'function') {
                        window.QuizApp.onShow();
                    }
                }
            },
            'stats': () => {
