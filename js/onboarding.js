...
(function() {
    ...
    function initSplash() {
        ...
        if (localStorage.getItem(PLEDGE_KEY) === 'true') {
            ...
            // 已签署过：首次点击自动全屏，避免 Edge 地址栏误触
            (function() {
                var first = function() { _tryFullscreen(); document.removeEventListener('touchstart', first); };
