/**
 * call-records.js - 通讯记录功能（自 D:\wz 移植）
 * 从所有会话中聚合通话记录，支持按伴侣筛选
 * 适配：wz 的 homeShowModal/homeHideModal → wz2 的 showModal/hideModal；
 *       sessionList（全局词法变量）→ resolveSessionList()；jumpToChat → hash + reload。
 */
(function() {
  'use strict';
  ...
  function resolveSessionList() {
    if (typeof sessionList !== 'undefined' && sessionList) return sessionList;
    return window.sessionList || [];
  }
