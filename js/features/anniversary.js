...
function _annUpdateHeaderDays() {
    ...
    textEl.innerHTML =
        '<div class="cs-days-title">' + escapeHtml(p.name) + ' ' + escapeHtml(p.verb) + '</div>'
        + '<div class="cs-days-line">'
        + '<span class="cs-days-num" id="cs-days-num">' + escapeHtml(String(p.days.toLocaleString('zh-CN'))) + '</span>'
