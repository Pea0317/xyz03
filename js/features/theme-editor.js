            ...
            themeSchemes.forEach(scheme => {
                ...
                item.innerHTML = `
                    ...
                    <div class="scheme-info">
                        <div class="scheme-name">${String(scheme.name == null ? '' : scheme.name).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}</div>
                        <div class="scheme-meta">${String(meta == null ? '' : meta).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}</div>
                    </div>
                    <div class="scheme-actions">
                        <button class="scheme-action-btn" title="应用方案" onclick="applyThemeScheme('${jsStr(scheme.id)}')">
                            <i class="fas fa-check"></i>
                        </button>
                        <button class="scheme-action-btn" title="在编辑器中编辑" onclick="editThemeScheme('${jsStr(scheme.id)}', event)" style="color:var(--accent-color);">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="scheme-action-btn delete" title="删除方案" onclick="deleteThemeScheme('${jsStr(scheme.id)}', event)">
